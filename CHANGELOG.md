...
- Merge old integration branch: `git merge origin/SCRAP/request-queue-2-clean-integrated-develop`.
- Merge `FIX/audit`: `git merge origin/FIX/audit`, which conflicted in 20 files.

```
git merge origin/FIX/audit
Auto-merging CHANGELOG.md
CONFLICT (content): Merge conflict in CHANGELOG.md
Auto-merging contracts/ethereum/artifacts/contracts/MinaAccountValidation.sol/MinaAccountValidation.json
CONFLICT (content): Merge conflict in contracts/ethereum/artifacts/contracts/MinaAccountValidation.sol/MinaAccountValidation.json
Auto-merging contracts/ethereum/artifacts/contracts/MinaAccountValidation.sol/artifacts.d.ts
CONFLICT (content): Merge conflict in contracts/ethereum/artifacts/contracts/MinaAccountValidation.sol/artifacts.d.ts
Auto-merging contracts/ethereum/artifacts/contracts/MinaStateSettlement.sol/MinaStateSettlement.json
CONFLICT (content): Merge conflict in contracts/ethereum/artifacts/contracts/MinaStateSettlement.sol/MinaStateSettlement.json
Auto-merging contracts/ethereum/artifacts/contracts/MinaStateSettlement.sol/artifacts.d.ts
CONFLICT (content): Merge conflict in contracts/ethereum/artifacts/contracts/MinaStateSettlement.sol/artifacts.d.ts
Auto-merging contracts/ethereum/artifacts/contracts/NoriProofRequestQueue.sol/NoriProofRequestQueue.json
CONFLICT (add/add): Merge conflict in contracts/ethereum/artifacts/contracts/NoriProofRequestQueue.sol/NoriProofRequestQueue.json
Auto-merging contracts/ethereum/artifacts/contracts/NoriProofRequestQueue.sol/artifacts.d.ts
CONFLICT (add/add): Merge conflict in contracts/ethereum/artifacts/contracts/NoriProofRequestQueue.sol/artifacts.d.ts
Auto-merging contracts/ethereum/artifacts/contracts/NoriTokenBridge.sol/NoriTokenBridge.json
CONFLICT (content): Merge conflict in contracts/ethereum/artifacts/contracts/NoriTokenBridge.sol/NoriTokenBridge.json
Auto-merging contracts/ethereum/artifacts/contracts/NoriTokenBridge.sol/artifacts.d.ts
CONFLICT (content): Merge conflict in contracts/ethereum/artifacts/contracts/NoriTokenBridge.sol/artifacts.d.ts
Auto-merging contracts/ethereum/artifacts/contracts/TimeLockController.sol/TimelockController.json
CONFLICT (content): Merge conflict in contracts/ethereum/artifacts/contracts/TimeLockController.sol/TimelockController.json
Auto-merging contracts/ethereum/artifacts/contracts/TimeLockController.sol/artifacts.d.ts
CONFLICT (content): Merge conflict in contracts/ethereum/artifacts/contracts/TimeLockController.sol/artifacts.d.ts
Auto-merging contracts/ethereum/contracts/NoriProofRequestQueue.sol
CONFLICT (add/add): Merge conflict in contracts/ethereum/contracts/NoriProofRequestQueue.sol
Auto-merging contracts/ethereum/contracts/NoriTokenBridge.sol
CONFLICT (content): Merge conflict in contracts/ethereum/contracts/NoriTokenBridge.sol
Auto-merging contracts/ethereum/test/NoriTokenBridge.ts
Auto-merging contracts/ethereum/types/ethers-contracts/NoriTokenBridge.ts
CONFLICT (content): Merge conflict in contracts/ethereum/types/ethers-contracts/NoriTokenBridge.ts
Auto-merging contracts/ethereum/types/ethers-contracts/factories/NoriProofRequestQueue__factory.ts
CONFLICT (add/add): Merge conflict in contracts/ethereum/types/ethers-contracts/factories/NoriProofRequestQueue__factory.ts
Auto-merging contracts/ethereum/types/ethers-contracts/factories/NoriTokenBridge__factory.ts
CONFLICT (content): Merge conflict in contracts/ethereum/types/ethers-contracts/factories/NoriTokenBridge__factory.ts
Auto-merging contracts/mina/package.json
CONFLICT (content): Merge conflict in contracts/mina/package.json
Auto-merging contracts/mina/src/depositAttestation.ts
CONFLICT (content): Merge conflict in contracts/mina/src/depositAttestation.ts
Auto-merging contracts/mina/src/env.ts
CONFLICT (content): Merge conflict in contracts/mina/src/env.ts
Auto-merging minimal-client/src/index.spec.ts
Auto-merging o1js-zk-utils/src/VerifiedRequestAttestor.ts
CONFLICT (add/add): Merge conflict in o1js-zk-utils/src/VerifiedRequestAttestor.ts
Auto-merging o1js-zk-utils/src/proofRequestQueueVectors.spec.ts
CONFLICT (add/add): Merge conflict in o1js-zk-utils/src/proofRequestQueueVectors.spec.ts
Auto-merging o1js-zk-utils/src/utils.ts
CONFLICT (content): Merge conflict in o1js-zk-utils/src/utils.ts
Automatic merge failed; fix conflicts and then commit the result.
```

### Conflict resolution

Full rationale for each item is in `merge-conflict.md`. Summary:

- `CHANGELOG.md`: took `origin/FIX/audit`'s side (the `pts-types` bump line and the a3850/d3034 write-ups).
- `contracts/ethereum/contracts/NoriTokenBridge.sol`: took `origin/FIX/audit`'s side. Also fixed a duplicate `queueFeeWei` declaration in `lockTokens` introduced by the automatic merge itself, outside any conflict marker.
- `contracts/ethereum/contracts/NoriProofRequestQueue.sol`: took `origin/FIX/audit`'s side (`requestProof` doc comment correction).
- `o1js-zk-utils/src/VerifiedRequestAttestor.ts`: took `origin/FIX/audit`'s side, which adds the `MAX_COLLECTION_KEYS !== 2` guard in `packRequestLeafFields`.
- `contracts/mina/src/depositAttestation.ts`: took `origin/FIX/audit`'s side, which adds the `collectionKeysCount.assertEquals(UInt8.from(1), ...)` check in `extractCodeChallengeAndTotalLocked`.
- `contracts/mina/src/env.ts`: took `CHORE/integration-audit-fix-develop-18-9-26-final`'s side, which carries the real staging `NORI_ETH_PROOF_QUEUE_ADDRESS` and matching token IDs; `origin/FIX/audit`'s side still had the all-zero placeholder.
- `contracts/mina/package.json`: `CHORE/integration-audit-fix-develop-18-9-26-final` had `0.3.48`, `origin/FIX/audit` had `0.3.43`. Took the higher of the two.
- `o1js-zk-utils/src/utils.ts`: took `origin/FIX/audit`'s side, which replaces a stale TODO/CHECKME comment with an explanation of why no in-circuit range check is needed on `bytes32LEToFieldProvable`'s input.
- `o1js-zk-utils/src/proofRequestQueueVectors.spec.ts`: add/add conflict, bodies identical apart from one test name. Took `origin/FIX/audit`'s side; ran the full spec, 139 tests passing.
- `contracts/ethereum/test/NoriTokenBridge.ts`: merged cleanly with no conflict markers.
- `package-lock.json`: no conflict, but stale against the resolved `contracts/mina/package.json` version. Fixed by `npm run reinstall`.
- Generated build artifacts (`contracts/ethereum/artifacts/**`, `contracts/ethereum/types/ethers-contracts/**`): regenerated from the resolved `.sol` sources by `npm run build`.
