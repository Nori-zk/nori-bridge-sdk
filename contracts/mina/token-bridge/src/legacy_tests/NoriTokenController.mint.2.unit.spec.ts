...
describe('NoriTokenController', () => {
    ...
    test('should deploy and initilise contracts', async () => {
        ...
        // tokenBaseAddress, noriTokenControllerAddress // NED TO ACUTALLY CONSTRUCT THE CONTACTS
        //noriTokenController = new NoriTokenController(PublicKey.fromBase58(noriTokenControllerAddress));
        //noriTokenController = new NoriTokenController(PublicKey.fromBase58(noriTokenControllerAddress));
    });
