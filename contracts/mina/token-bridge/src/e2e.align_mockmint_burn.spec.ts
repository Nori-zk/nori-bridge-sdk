...
describe('e2e_devnet', () => {
    ...
    test('e2e_align_mockmint_burn_devnet', async () => {
        ...
        let receiver_at_eth_side = Field(BigInt('0x7adcb2af858e084e1ecadc6892391f1fcfcd80ba'));
    ...
    `);
        ...
        */
        ...
        await txSend({
            body: async () => {
                await noriTokenController.alignedLock(amountToBurn, receiver_at_eth_side);
            },
            sender: alice.publicKey,
            signers: [alice.privateKey],
        });
